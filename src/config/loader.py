    ...
    try:
        ...
        logger.info(
            ...
            approved_directories=[
                str(root) for root in settings.all_approved_directories
            ],
...
def _validate_config(settings: Settings) -> None:
    ...
    # Check file system permissions (every approved root)
    try:
        for approved_root in settings.all_approved_directories:
